...
%Do not use amssymb, input/output enc, bm, with lualatex (that stuff is built-in)
...
%% 2. Use "\tagpdfsetup{
    ...
    %Math tagging is not required by ISU, but nice to have
...
%Following makes proof more reliable for tagging
\makeatletter
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%we are manually adding nomeclature to the TOC, hence notintoc
