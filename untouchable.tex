...
\newcommand{\theTitle}{Thiss is the title of a thesis
submitted to Iowa State University\\
Note that only the first letter of
the first word and proper names
are capitalized}
\newcommand{\theShortTitle}{This is the title of a thesis
submitted to Iowa State University}
\newcommand{\theAuthor}{Not My Name}
...
pdftitle=\theShortTitle,]{hyperref}
