...
\documentclass[math-packages,algorithms-packages]{isuthesistagged}
...
% bib-no-break: by default, page breaks in the middle of entries are discouraged, but may happen for a particularly long entry (4+ lines).
