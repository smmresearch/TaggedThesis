...
%algorithms-packages loads: algorithm, algpseudocode (noend package option)
...
%search for "{packageName}" in the class file to find the line it is loaded to change options as needed
...
\tagtool{flush-floats=subsection}%add this command to keep floats where they are supposed to be in the tagging tree
\clearpage
\pagebreak
\end{document}
